...
public class JProDemo extends JProApplication {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Node pdfDisplayerNode = displayer.toNode();
        VBox.setVgrow(pdfDisplayerNode, Priority.ALWAYS);
        primaryStage.setScene(new Scene(new VBox(btn, pdfDisplayerNode, javaInfo)));
        primaryStage.show();
